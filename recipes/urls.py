...
urlpatterns = [
    ...
    # Favorites system
    path(
        'recipes/favorite/<int:recipe_id>/',
    ...
    path(
        'app-admin/recipes/create/',
        views.RecipeCreateView.as_view(),
        name='admin_recipe_create'
    ),
    path(
        'app-admin/recipes/<int:pk>/edit/',
        views.RecipeUpdateView.as_view(),
        name='admin_recipe_edit'
    ),
    path(
        'app-admin/recipes/<int:pk>/delete/',
